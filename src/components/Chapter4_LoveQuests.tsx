...
export const Chapter4_LoveQuests: React.FC = () => {
  ...
  return (
    <div className="fixed top-24 right-4 md:right-8 z-50 flex justify-end items-start pointer-events-none">
      <AnimatePresence mode="wait">
        {isOpen ? (
          <motion.div 
            ...
            className="glass-card p-6 border-primary/30 relative w-72 md:w-80 pointer-events-auto"
          ...
          >
            <button
              ...
              className="glass-button !p-0 w-14 h-14 flex items-center justify-center rounded-full shadow-[0_0_20px_rgba(255,110,199,0.4)] relative bg-black/40 backdrop-blur-xl border border-primary/40 text-white hover:bg-black/60 hover:scale-110 transition-all pointer-events-auto"
